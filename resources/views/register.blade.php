        ...
        <div class="row justify-content-center">
          <div class="col-md-6">
            ...
            <div class="card-body">
                ...
                <div class="">
                <label class="" onclick="hideshow()">Click here for <a href="#">Login</a>.</label>
                </div>
                </div>
                </form>
            </div>
            ...
            <div class="card card-primary" id="log_sec">
              <div class="card-header">
                <h3 class="card-title">Login <small>here</small></h3>
              </div>
                ...
                <form role="form" id="quickForm1">
                  ...
                  <input type="email" name="email_l" class="form-control" id="email_l" placeholder="Enter email">
                  </div>
                  <div class="form-group">
                  <label for="exampleInputPassword1">Password</label>
                  <input type="password" name="password_l" class="form-control" id="password_l" placeholder="Password">
                  </div>
                  <div class="form-group mb-0">
                  <div class="">
                  <label class="" onclick="hideshow1()">Click here for <a href="#">Register</a>.</label>
                  </div>
                  </div>
                  </div>
                  <div class="card-footer">
